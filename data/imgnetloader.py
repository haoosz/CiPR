...
def IMGNet100Data_GCD(root, aug=None, num_lab_classes=50):
...
def IMGNet100LoaderMixGCD(root, batch_size, num_workers=2, aug=None, shuffle=True, sampler=None, num_lab_classes=50):
    dataset = IMGNet100Data_GCD(root, aug, num_lab_classes)
